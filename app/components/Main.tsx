    ...
    <div className="flex-1 min-h-screen pb-[15vh] relative">
      ...
      <div className="max-w-[900px] m-auto">
        ...
        <div className="grid grid-cols-4 gap-[15px] p-[20px]">
          ...
          <div className="h-[200px] p-[15px] bg-[#f0f4f9] rounded-[10px] relative cursor-pointer hover:bg-[#dfe4ea]">
            <p className="text-[#585858] text-[17px]">Briefly summarize this concept: Photosynthesis</p>
            <Image
              className="absolute rounded-[20px] bottom-[10px] right-[10px]"
              height={25}
              width={25}
        ...
        <div className="absolute bottom-4 w-full max-w-[900px] px-[20px] m-auto">
          <div className="flex items-center justify-between gap-[20px] bg-[#f0f4f9] py-[10px] px-[20px] rounded-[50px]">
            <input className="flex-1 bg-transparent border-none outline-none p-[5px] text-[18px]" type="text" placeholder="Enter a prompt here" />
            <div className="flex gap-3">
              <Image className="cursor-pointer" width={20} height={20} src="/assets/gallery_icon.png" alt="gallery icon"/>
              <Image className="cursor-pointer" width={20} height={20} src="/assets/mic_icon.png" alt="mic icon"/>
              <Image className="cursor-pointer" width={20} height={20} src="/assets/send_icon.png" alt="send icon"/> 
            </div>
          </div>
        </div>
      </div>
